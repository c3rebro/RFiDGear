...
using RFiDGear.DesfirePluginSample.Model;
...
namespace RFiDGear.Tests
{
    public class DesfireSamplePluginTests
    {
        ...
        public void DesfireSamplePlugin_IsConfiguredForMefLoading()
        {
            ...
            Assert.Equal("pack://application:,,,/RFiDGear.DesfirePluginSample;component/View/DesfireSampleView.xaml", attribute.Uri);
