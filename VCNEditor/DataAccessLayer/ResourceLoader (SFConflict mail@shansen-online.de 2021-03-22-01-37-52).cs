...
namespace VCNEditor.DataAccessLayer
{
	...
	public sealed class EnumerateExtension : MarkupExtension
	{
		...
		{
			this.Type = type;
			resManager = new ResourceManager(@"VCNEditor.Resources.Manifest", typeof(VCNEditor.ViewModel.VCNEditorViewModel).Assembly);
	...
	public sealed class ResourceLoader : IValueConverter, IDisposable
	{
		...
		public static string getResource(string resName)
		{
			...
			try
			{
				System.Reflection.Assembly ass = typeof(VCNEditor.ViewModel.VCNEditorViewModel).Assembly;

				return new ResourceManager(@"VCNEditor.Resources.Manifest", ass)
