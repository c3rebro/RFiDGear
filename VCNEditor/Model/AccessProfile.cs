...
namespace VCNEditor.Model
{
    ...
    public class AccessProfile
    {
        ...
        public string ProfileDesc { get { return string.Format("{0}:{1}:{2}", ProfileType, ByteArrayHelper.Extensions.ByteConverter.GetStringFrom(AccessProfileAsBytes), ByteArrayHelper.Extensions.ByteConverter.GetStringFrom(MainListWords)); } }
    }
}
