...
namespace RFiDGear.ViewModel
{
	...
	public class TreeViewParentNodeViewModel : INotifyPropertyChanged
	{
		...
		readonly Model.chipMifareClassicUid _chipMifareClassicUid;
		readonly Model.chipMifareDesfireUid _chipMifareDesfireUid;
		...
		public TreeViewParentNodeViewModel(Model.chipMifareClassicUid uid, CARD_TYPE cardType)
		{
		...
		public TreeViewParentNodeViewModel(Model.chipMifareDesfireUid uid, CARD_TYPE cardType)
		{
		...
		void LoadChildren()
		{
			...
			switch (_cardType) {
				case CARD_TYPE.CT_CLASSIC_1K:
					{
						for (int i = 0; i < 16; i++) {
							_children.Add(new ViewModel.TreeViewChildNodeViewModel(new Model.chipMifareClassicSector(i), this, _cardType, i));
						}
				...
				case CARD_TYPE.CT_DESFIRE_EV1:
					{
						_children.Add(new ViewModel.TreeViewChildNodeViewModel(new Model.chipMifareDesfireAppID(),this, _cardType));
					}
					break;
			}
		}
